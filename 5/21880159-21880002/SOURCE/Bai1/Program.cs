...
namespace Bai1
{
    ...
    public class Dijkstra
    {
        ...
        public void dijkstra(int[,] a)
        {
            ...
            for (int i = 0; i < count; i++)
            {
                Console.WriteLine("Lan " + i);
                for (int l = 0; l < visitedVertex.Length; l++)
                {
                    Console.Write(visitedVertex[l] + " ");
                }
                Console.WriteLine();
                //in distance
                ...
                {
                    Console.Write(prev[m] + " ");
                }
                int u = findMinDistance(dist, visitedVertex);

                //kiem tra khong co duong di
                if (u == -1)
                {
    ...
    class Program
    {
        ...
        {
            string path = @"D:\HUS\LyThuyetDoThi\BT\5\21880159-21880002\SOURCE\Bai1\input.txt";
